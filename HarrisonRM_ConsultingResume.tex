...
\section{Experience}
\textbf{Technical}
%\nblocdatesubsection{University of Oxford}{Oxford, UK}{2010--Present} \\
%Graduate Research Assistant
%\begin{itemize}
%    \item Spearheaded software integration testing and automated documentation efforts, resulting in a dramatic reduction in both scientific and build errors.
%\end{itemize}
...
\nblocdatesubsection{National Institute for Materials Science}{Tsukuba, Japan}{2008} \\
...
\nblocdatesubsection{Johns Hopkins University}{Baltimore, MD}{2003 -- 2007} \\
...
\begin{itemize}
    \item \nbdatesubsection{oxTalent Infographic Award <10\%}{2012}
    \item \nbdatesubsection{NIH Graduate Research Award for Poster Presentation <10\%}{2011}
\end{itemize}
\textbf{Fellowships \& Prizes}
\begin{itemize}
    \item \nbdatesubsection{NIH-Oxford Scholar <10\%}{2010}
    \item \nbdatesubsection{National Science Foundation Graduate Research Fellow <10\%}{2010}
    \item \nbdatesubsection{Inductee, National Gallery for America's Young Inventors <1\%}{2006}
    \item \nbdatesubsection{5th Place, Intel Science Talent Search <1\%}{2005}
        \begin{itemize}
            \item Dubbed the `junior nobel prize.' First from Baltimore City in 50 years.
        \end{itemize}
\end{itemize}
